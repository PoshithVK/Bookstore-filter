...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check body sections of the Object Page", function (Given, When, Then) {
            ...
            Then.onTheBooksObjectPage.onForm({ section: "GeneratedFacet1" }).iCheckField({ property: "genre" });
            Then.onTheBooksObjectPage.onForm({ section: "GeneratedFacet1" }).iCheckField({ property: "price" });
            Then.onTheBooksObjectPage.onForm({ section: "GeneratedFacet1" }).iCheckField({ property: "rating" });
            Then.onTheBooksObjectPage.onForm({ section: "GeneratedFacet1" }).iCheckField({ property: "stock" });
            Then.onTheBooksObjectPage.onForm({ section: "GeneratedFacet1" }).iCheckField({ property: "isbn" });
            Then.onTheBooksObjectPage.onForm({ section: "GeneratedFacet1" }).iCheckField({ property: "publishDate" });
       });
